  ...
  return knex('feelings').del()
    .then(function () {
      ...
      return knex('feelings').insert([
        ...
        {id: 8, name: 'Harsh Anger',description: 'booyah', is_loved: false, is_default: false},
        {id: 9, name: 'Passive', description: 'booyah',is_loved: false, is_default: false},
        {id: 10, name: 'Critical', description: 'booyah',is_loved: false, is_default: false},
        {id: 11, name: 'No Voice', description: 'booyah',is_loved: false, is_default: false},
        {id: 12, name: 'Unsolicited Advice', description: 'booyah',is_loved: false, is_default: false},
        {id: 13, name: 'Stonewalling', description: 'booyah',is_loved: false, is_default: false},
        {id: 14, name: 'Defensive', description: 'booyah',is_loved: false, is_default: false},
      ])
    })
    .then(() => {
      return knex.raw(
