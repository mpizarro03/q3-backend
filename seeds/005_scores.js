  ...
  return knex('scores').del()
    .then(function () {
      ...
      return knex('scores').insert([
        ...
        {id: 7, couple_id: 1, from_user_id: 2 , to_user_id: 1, users_feelings_id:2 , score: 2, feedback: "I really like it when we went for a walk at Boulder Creek on Monday." },
        {id: 8, couple_id: 1, from_user_id: 2 , to_user_id: 1, users_feelings_id:3 , score: 7, feedback: "I liked that you surpised me at work during lunch yesterday, that made my day." },
